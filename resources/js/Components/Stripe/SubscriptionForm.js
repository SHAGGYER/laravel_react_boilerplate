    ...
    return (
        <form onSubmit={handleSubmit} style={{paddingTop: "1rem"}}>
            ...
            <div className="mt-1 center">
                <Button className="btn--primary mr-1" onClick={() => setActiveStep(prevState => prevState - 1)}>
                    Tilbage
                </Button>
                <Button className="btn--primary" type="submit" loading={submitting} disabled={submitting}>Abonnér</Button>
            </div>
